...
export class BiometricsService {
  ...
  public readonly isAppBackOnForeground : Signal<boolean> = computed(() => this._isAppBackOnForeground());
  ...
  async hasBiometricEnabled(): Promise<boolean> {
    ...
    const data: (string | null) = await this.localStorageService.getStoredData(LocalStorageKey.HasBiometricEnabled);
    if (data === null) {
